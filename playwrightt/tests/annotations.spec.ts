...
test("test3", async () => {
    test.slow(); // putting this inside the test case will mark the test case as slow, which means that the test case will be executed but will be marked as slow if it takes longer than a specified time to execute.
    console.log("TEST3");
});
